...
function tgl_indo($tanggal)
{
    ...
    <h3 align="center" style="font-size: 16px;"><u>LAPORAN DATA HISTORY PENGGUNAAN <br> <?php echo strtoupper(tgl_indo($tgl1));?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($tgl2));?></u> <br> </h3>
    <br>
 ...
 <tr>
                          ...
                          <th>Nama Lengkap</th>
                          <th>NIP</th>
                          <th>Tanggal Jam Penggunaan</th>
                          <th>Jenis Penggunaan</th>
                        </tr>
                      </thead>
                        <tbody>
                                             <?php $no=1; foreach ($data_history_penggunaan->result_array() as $i) :
                                            $id_history_penggunaan=$i['id_history_penggunaan'];
                                          ?>
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo tgl_indo(date('Y-m-d',strtotime($i['tanggal_jam'])));?>, <?php echo date('H:i',strtotime($i['tanggal_jam']));?></td>
                                              <td><?php echo $i['jenis_penggunaan'];?></td>
        </tr>
            <?php endforeach;?>
    </table>
<BR><BR>
