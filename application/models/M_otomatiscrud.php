...
class M_otomatiscrud extends CI_Model{
    ...
    if (empty($cetak_satuan)) {
      ...
      $button_cetak_satuan='<a target="_blank" style="margin: 2px;" href="'.$nama_asal.'/cetak2/<?php echo $id_'.$nama_asal.';?>" type="button" class="btn btn-success mdi mdi-pencil btn-sm" > CETAK</a>';
    }
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                 <h4 class="card-title"> <b>DAFTAR '.$nama_asal2.'</b>  
                 <a target="_blank" style="margin: 2px; float: right;" class="btn btn-primary btn-sm" href="<?php echo base_url();?>'.$nama_asal.'/cetak"><i class="fa fa-print"></i> CETAK </a>
                 <button style="margin: 2px; float: right;" type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modaltambah"><i class="fa fa-plus"></i> TAMBAH '.$nama_asal2.'</button></h4>
                ...
                <div class="card-content collpase show">
                  <div class="card-body card-dashboard">
                    ...
                    <table class="table table-striped table-bordered zero-configuration '.$tabel_responsive.'" id="mytable">
                      <thead>
                        <tr>
        <th style="flex: 0 0 auto; min-width: 2em;">No.</th>
       	...
       	<td style="flex: 0 0 auto; min-width: 2em;"><?php echo $no++;?></td>
				'.$string_kolom2.'
                                              ...
                                              <button style="margin: 2px;" type="button" class="btn btn-info mdi mdi-pencil btn-sm" data-toggle="modal" data-target="#ModalUpdate<?php echo $id_'.$nama_asal.';?>"> EDIT</button>

                                              <button style="margin: 2px;" type="button" class="btn btn-danger mdi mdi-delete-empty btn-sm" data-toggle="modal" data-target="#ModalHapus<?php echo $id_'.$nama_asal.';?>"> DELETE</button>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-success white">
                                  <h4 class="modal-title" id="myModalLabel9"> <b>TAMBAH '.$nama_asal2.'</b></h4>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-info white">
                                  <h4 class="modal-title" id="myModalLabel9"> <b>UPDATE '.$nama_asal2.'</b></h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
   ...
   <div class="form-group">
                          ...
                          aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-info white">
                                  <h4 class="modal-title" id="myModalLabel9"> <b>HAPUS '.$nama_asal2.'</b></h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
      ...
      <table border="0" align="center" width="100%">
        <tr align="center">
           ...
           <td>
                ...
                <font style="margin-right: 70px;" size="3">Jalan Pemuda Km. 5,5 No. 1 Telp. (0513) – 21005 KODE POS 73515 <br> K U A L A   K A P U A S
</font>
            </td>
        </tr>
        <tr>
     ...
     <section id="server-processing">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                 <h4 class="card-title"> <b>Laporan '.$nama_asal3.'</b>
       </h4>
                </div>
                <div class="card-content collpase show">
                  <div class="card-body card-dashboard">
