...
function tgl_indo($tanggal)
{
    ...
    <h3 align="center" style="font-size: 16px;"><u>LAPORAN PROPOSAL PENCAIRAN <br><?php if(!empty($jenis_penerima)):?><?php echo strtoupper($jenis_penerima);?><?php endif;?> <br> <?php echo strtoupper(tgl_indo($tgl1));?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($tgl2));?> </u> <br> </h3>
    <br>
  ...
  <tr>
        ...
        <th>Anggaran Yg Disetujui</th>
                        ...
                        <tbody>
                                             <?php $no=1; $a=0; $b=0; foreach ($data_proposal_pencairan->result_array() as $i) :
