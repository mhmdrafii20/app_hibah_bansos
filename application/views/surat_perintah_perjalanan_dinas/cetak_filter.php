...
function tgl_indo($tanggal)
{
    ...
    <h3 align="center" style="font-size: 16px;"><u>LAPORAN SURAT PERINTAH PERJALANAN DINAS <br> <?php echo strtoupper(tgl_indo($tgl1));?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($tgl2));?> </u> <br> </h3>
    <br>
...
<BR><BR>
   <div style="text-align: left; display: inline-block; float: right; margin-right: 50px; font-size: 11pt;">
        <label>
            Ditetapkan di Kotabaru<br>
            Pada tanggal <?= tgl_indo(date('Y-m-d')) ?>
            <br>
            <p style="text-align: center;">
                <b>Ketua Pengadilan Negeri Kotabaru Kelas II</b><br>
            </p>
            <br><br><br>
            <p style="text-align: center;">
                <b><u>AHMAD SHUHEL NADJIR, S.H., M.H.</u></b><br>
