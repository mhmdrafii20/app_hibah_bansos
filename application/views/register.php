              ...
              <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    ...
                    <h6 style="font-weight: bold; font-family: 'Times New Roman'; font-weight: bold; color: black;">FORM PEMOHON HIBAH BANSOS</h6>
                  </div>
                ...
                <h4 style="text-shadow: 0px 0px 0.5px#000000; font-weight: bold; font-size: 19px;" ><center></center></h4>
                  <div class="card-body">
                    <form class="form-horizontal" action="<?php echo base_url();?>login/aksi_reg" method="POST" novalidate>
                      <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="nik" name="nik" class="form-control"  placeholder="NIK"
                        required>
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                       ...
                       <fieldset class="form-group position-relative has-icon-left">
                        <input type="nama_penerima" name="nama_penerima" class="form-control"  placeholder="Nama Rumah Ibadah/Lembaga/Ormas"
                        required>
                        <div class="form-control-position">
                          <i class="ft-home"></i>
                        </div>
                       ...
                       <fieldset class="form-group position-relative has-icon-left">
                        <input type="alamat_penerima" name="alamat_penerima" class="form-control"  placeholder="Alamat Rumah Ibadah/Lembaga/Ormas"
                        required>
                        <div class="form-control-position">
                          <i class="ft-home"></i>
                        </div>
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                        <input autocomplete="new-password" type="password" name="password2" class="form-control"  placeholder="Ulangi Password"
                        required>
                        <div class="form-control-position">
                          <i class="fa fa-key"></i>
                        </div>
                   ...
                   <div class="form-group row">
                    <div class="col-md-6 col-12 text-center text-md-left">
                      ...
                      <a  class="btn btn-outline-success btn-block" href="<?php echo base_url();?>login"> Kembali ke Login</a>
...
<?php if($this->session->flashdata('saw') == TRUE): ?>
 <script type="text/javascript">
 swal("", "Password dan Ulangi Password SALAH", "error");
 </script>
<?php endif; ?>

<?php if($this->session->flashdata('usernameada') == TRUE): ?>
 <script type="text/javascript">
 swal("", "NIK Anda sudah terdaftar", "error");
 </script>
<?php endif; ?>