...
function tgl_indo($tanggal)
{
    ...
    <h3 align="center" style="font-size: 16px;"><u>LAPORAN DATA PEGAWAI <br> <?php echo strtoupper(tgl_indo($tgl1));?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($tgl2));?></u> <br> </h3>
    <br>
