...
function tgl_indo($tanggal)
{
    ...
    <h3 align="center" style="font-size: 16px;"><u>LAPORAN PENGAJUAN PROPOSAL <br><?php if(!empty($jenis_penerima)):?><?php echo strtoupper($jenis_penerima);?><?php endif;?> <?php if(!empty($status_proposal)):?>STATUS <?php echo strtoupper($status_proposal);?><?php endif;?> <br> <?php echo strtoupper(tgl_indo($tgl1));?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($tgl2));?></u> <br> </h3>
    <br>
